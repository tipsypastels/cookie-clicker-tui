...
pub fn debug(app: &mut UiApp, view: AppDebugView, area: Rect, buf: &mut Buffer) {
    ...
    let text = match view {
        ...
        AppDebugView::ThousandFingers => format!("{:?}", core.debug_thousand_fingers()),
        ...
        AppDebugView::Changeset => format!("{:?}", app.changeset),
